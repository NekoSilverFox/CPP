...
public:
	...
	{
		val_static = 0;
		root_ = CreatBinarySearchTreeITERATION(10);
		CreatBinarySearchTreeITERATION(20);
		CreatBinarySearchTreeITERATION(3);
		CreatBinarySearchTreeITERATION(30);
		CreatBinarySearchTreeITERATION(9);
		CreatBinarySearchTreeITERATION(15);
	}
	...
	{
		enum Method { DLR_recursion = 1, LDR_recursion, LRD_recursion, ALL_recursion, depth_first, breadth_first	};
		int user_choose = method;
		...
		case LRD_recursion:
			ForeachTreeLRD(this->root_);
			break;

		case ALL_recursion:
			cout << "DLR : "; ForeachTreeDLR(this->root_); cout << endl;
			cout << "LDR : "; ForeachTreeLDR(this->root_); cout << endl;
			cout << "LRD : "; ForeachTreeLRD(this->root_); cout << endl;
			break;

		case depth_first:
			ForeachDepthFirst(this->root_); //  <<<<<=========================LAB6==========================
			break;

		case breadth_first:
			ForeachBreadthFirst(this->root_);
			break;
...
private:
	...
	Node* CreatBinarySearchTreeITERATION(T key_cin)
	{
		//T key_cin;
		//cout << "Value = " << val_static << " | Key = "; cin >> key_cin;
	...
	/*****************************Foreach the Binary Search Tree*****************************/
	void ForeachTreeDLR(Node* root)
	{
		if (nullptr == root) return;

		cout << endl << root->val_ << " " << root->key_ << endl;
		// cout << root->key_ << " ";
		ForeachTreeDLR(root->left_);
		ForeachTreeDLR(root->right_);
	}
	...
	void ForeachTreeLRD(Node* root)
	{
		if (nullptr == root) return;

		ForeachTreeLRD(root->left_);
		ForeachTreeLRD(root->right_);
		cout << root->key_ << " ";
	}

	void ForeachDepthFirst(Node* root) //  <<<<<=========================LAB6==========================
	{
		if (nullptr == root)
		{
	...
	void ForeachBreadthFirst(Node* root) //  <<<<<=========================LAB6==========================
	{
